...
func main() {
	...
	// Pass the values to be sorted to the kernel

	// Set the first value to 1
	krnl.SetArg(0, 1)
	// Set the second value to 8
	krnl.SetArg(1, 8)
	// Set the third value to 76
	krnl.SetArg(2, 76)
	// Set the forth value to -123
	krnl.SetArg(3, -123)
	// Set the pointer to the result address in shared memory
	krnl.SetMemoryArg(4, buff)
